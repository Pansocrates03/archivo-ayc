<script lang="ts">
    import type { Grupo } from '../types/alltypes';

    export let searchTerm: string = '';
    export let selectedGroup: string = '';
    export let allGroups: Grupo[] = [];

    // Listas reactivas por presentadopor
    let prepa: Grupo[] = [];
    let arte: Grupo[] = [];
    let otros: Grupo[] = [];
    ...
    <div class="mx-auto max-w-3xl flex flex-col md:flex-row items-center gap-4">
        <div class="relative flex-1">
            <input
                ...
                class="block w-full rounded-full border-2 border-gray-200 bg-white px-6 py-4 text-lg shadow-lg transition-all duration-300 focus:border-indigo-500 focus:outline-none focus:ring-4 focus:ring-indigo-200 focus:-translate-y-1"
            />
        ...
        <div class="relative flex-1">
            <select
                ...
                class="block w-full rounded-full border-2 border-gray-200 bg-white px-6 py-4 text-lg shadow-lg transition-all duration-300 focus:border-indigo-500 focus:outline-none focus:ring-4 focus:ring-indigo-200 focus:-translate-y-1 appearance-none pr-10"
            >
